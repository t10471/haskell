...
showsTerm d (Int i)           =  showsString "Int " . shows i
showsTerm d (Var x)           =  showsString "Var " . showsString x
showsTerm d (Abs x v)         =  showsParenIf (d>0)
                                 (showsString "Abs " . showsString "\\" . showsString x . showsAbs v)
showsTerm d (App t u)         =  showsParenIf (d>1)
                                 (showsString "App " . showsTerm 1 t . showsChar ' ' . showsTerm 2 u)
showsTerm d (Let x u v)       =  showsParenIf (d>0)
                                 (showsString "Let " . showsString "let  "   . showsString x .
